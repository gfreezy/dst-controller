...
---@field CONTROL_TARGET_CYCLE number
---@field CONTROL_AXISALIGNEDPLACEMENT_CYCLEGRID number
...
function G.Init(global_arg, env_arg)
    ...
    G.BUTTON_MAPPINGS = {
        ...
        Y = { G.CONTROL_MENU_MISC_2, G.CONTROL_INSPECT, G.CONTROL_USE_ITEM_ON_ITEM, G.CONTROL_TARGET_CYCLE, G.CONTROL_AXISALIGNEDPLACEMENT_CYCLEGRID },
