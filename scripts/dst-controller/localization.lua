...
local STRINGS_TABLE = {
    ...
    en = {
        ...
        SETTING_LB_MODIFIER = "LB Keyboard Modifier",
        SETTING_RB_MODIFIER = "RB Keyboard Modifier",
        ...
        ACTION_OPEN_SKILL_WHEEL = "Open Skill Wheel",
        ACTION_CAST_SKILL = "Cast Skill [Needs Param]",
        ACTION_OPEN_SKILL_PANEL = "Open Skill Panel",
        ...
        LABEL_SKILL_SEARCH = "Skill Search:",
        LABEL_SKILL_RESULT = "Skill:",
        LABEL_SKILL_CHARACTER = "Character:",
        SKILL_CHARACTER_EMPTY = "No character skills",
        SKILL_SEARCH_RESULTS = "%d skills; use the arrows below to choose",
        SKILL_SEARCH_EMPTY = "No matching skill; try another keyword",
        SKILL_UNAVAILABLE = "%s [Currently unavailable]",
    ...
    zh = {
        ...
        SETTING_LB_MODIFIER = "LB 键盘修饰键",
        SETTING_RB_MODIFIER = "RB 键盘修饰键",
        ...
        ACTION_OPEN_SKILL_WHEEL = "打开技能轮盘",
        ACTION_CAST_SKILL = "释放技能 [需要参数]",
        ACTION_OPEN_SKILL_PANEL = "打开技能面板",
        ...
        LABEL_SKILL_SEARCH = "搜索技能:",
        LABEL_SKILL_RESULT = "技能:",
        LABEL_SKILL_CHARACTER = "选择人物:",
        SKILL_CHARACTER_EMPTY = "没有人物技能",
        SKILL_SEARCH_RESULTS = "找到 %d 个技能，请用下方箭头选择",
        SKILL_SEARCH_EMPTY = "没有匹配的技能，请更换关键词",
        SKILL_UNAVAILABLE = "%s [当前不可用]",
